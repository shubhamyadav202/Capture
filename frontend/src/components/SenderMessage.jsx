...
const SenderMessage = ({ message }) => {
  ...
  return (
    <div
      ref={scroll}
      className="w-fit max-w-[70%] sm:max-w-[60%] bg-gradient-to-br from-[#9500ff] to-[#ff0095] rounded-t-2xl rounded-bl-2xl rounded-br-0 px-[10px] py-[10px] relative ml-auto right-0 flex flex-col gap-[10px]"
    >
      {sharedPost && (
        <div
